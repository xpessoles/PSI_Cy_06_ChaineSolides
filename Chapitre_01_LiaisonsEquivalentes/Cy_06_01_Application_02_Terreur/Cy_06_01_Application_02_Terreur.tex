% "{'classe':('PSI'),'chapitre':'chs_leq','type':('td'),'titre':'Tour de la terreur', 'source':'Vuibert','comp':['B2-15','CHS-01','CHS-02'],'corrige':False}"
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_06_01_Application_02_Terreur_qr}
\end{marginfigure}
\fi
