% "{'classe':('PSI'),'chapitre':'chs_hs','type':('colle'),'titre':'Interface maître et esclave d\\'un robot', 'source':'CCP PSI 2015','comp':[],'corrige':True}"
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_06_02_Colle_02_Hoeken_qr}
\end{marginfigure}
\fi
