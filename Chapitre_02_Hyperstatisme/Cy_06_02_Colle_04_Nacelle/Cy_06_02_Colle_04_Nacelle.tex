...
$=\torseurl{\gammap \vx{0}}{\vect{0}}{H_1}+\torseurl{\deltap_y \vy{0}+\deltap_z \vz{0}}{\mup_x\vx{0}+\mup_y\vy{0}}{H_1}$

$=\torseurl{\gammap \vx{0}+\deltap_y \vy{0}+\deltap_z \vz{0}}{\mup_x\vx{0}+\mup_y\vy{0}}{C_1}$.

La liaison équivalente est une liaison linéaire ponctuelle (sphère -- plan) de normale 
$\axe{H_1}{z_0}$.
...
\ifprof
\begin{corrige}
Cette solution permet d'avoir toujours les 4 roues en contact avec le sol, quel que soit le terrain, même s'il est accidenté. 
\end{corrige}
\else\fi
