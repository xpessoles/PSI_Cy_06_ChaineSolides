...
\question{En utilisant le modèle de la figure \ref{fig_02}, proposer une liaison entre le corps du vérin d'une part et le châssis d'autre part. Proposer ensuite une liaison entre la tige du vérin d'une part et l'essieu avant d'autre part.}
\ifprof
\begin{corrige}
...
\question{Déterminer alors le degré d'hypestatisme du mécanisme.}
\ifprof
\begin{corrige}
