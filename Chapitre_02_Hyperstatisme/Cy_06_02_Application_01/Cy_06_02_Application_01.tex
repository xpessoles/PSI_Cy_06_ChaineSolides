...
\includegraphics[width=.8\linewidth]{fig_21.png}
\includegraphics[width=.8\linewidth]{fig_22.png}
\includegraphics[width=.8\linewidth]{fig_23.png}
\end{multicols}
\end{table*}
...
\begin{marginfigure}
\centering
\includegraphics[width=3cm]{Cy_06_02_Application_01_qr}
\end{marginfigure}
\fi
